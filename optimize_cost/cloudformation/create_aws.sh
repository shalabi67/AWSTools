...
#aws cloudformation create-stack --stack-name pf1-live  --template-body file://./cloudformation/team.yaml --parameters file://./cloudformation/backend-live.json
#aws cloudformation create-stack --stack-name pf1-live-project2  --template-body file://./cloudformation/team.yaml --parameters file://./cloudformation/backend-live-project.json
